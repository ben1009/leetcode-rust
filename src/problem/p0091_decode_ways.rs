...
/// the reverse of the mapping above (there may be multiple ways). For example, "11106" can be
/// mapped into:
///
...
/// different from "06". Given a string s containing only digits, return the number of ways to
/// decode it. The test cases are generated so that the answer fits in a 32-bit integer.
///  
