...
// operations[i] is "C", "D", "+", or a string representing an integer in the range [-3 * 104, 3 *
// 104]. For operation "+", there will always be at least two previous scores on the record.
