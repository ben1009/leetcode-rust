...
/// [a[n-1], a[0], a[1], a[2], ..., a[n-2]]. Given the sorted rotated array nums of unique elements,
/// return the minimum element of this array. You must write an algorithm that runs in O(log n)
/// time.  
